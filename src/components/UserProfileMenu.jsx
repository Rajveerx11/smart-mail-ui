      ...
      >
        ...
        <div className="flex flex-col items-center py-5">
          ...
          <button
            ...
            className="mt-4 px-4 py-1.5 text-sm border rounded-full hover:bg-gray-100"
          >
        ...
        <div className="border-t">
          <button className="flex items-center gap-3 px-5 py-3 w-full hover:bg-gray-100 text-sm">
            <User size={18} /> Profile
          </button>

          <button className="flex items-center gap-3 px-5 py-3 w-full hover:bg-gray-100 text-sm text-red-600">
